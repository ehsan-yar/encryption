package com.ehsanyar.encryption.service.dukpt;
 ...
 * Modified by ehsanyar1991 for Spring framework
 */
...
public final class Dukpt {
	 ...
	 * @throws Exception
	 */
	private BitSet _getCurrentKey(BitSet ipek, BitSet ksn) throws Exception {
	 ...
	 * @throws Exception
	 */
	private BitSet _nonReversibleKeyGenerationProcess(BitSet p_key, BitSet data) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] encryptDes(byte[] key, byte[] data, boolean padding) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] decryptDes(byte[] key, byte[] data, boolean padding) throws Exception {
		IvParameterSpec iv = new IvParameterSpec(new byte[8]);
	 ...
	 * @throws Exception
	 */
	public byte[] decryptDes(byte[] key, byte[] data) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] encryptTripleDes(byte[] key, byte[] data, boolean padding) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] decryptTripleDes(byte[] key, byte[] data, boolean padding) throws Exception {
		BitSet bskey = toBitSet(key);
		BitSet k1, k2, k3;
		if (bskey.length() == 64) {
			// single length
	 ...
	 * @throws Exception
	 */
	public byte[] encryptTripleDes(byte[] key, byte[] data) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] decryptTripleDes(byte[] key, byte[] data) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] encryptAes(byte[] key, byte[] data, boolean padding) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] decryptAes(byte[] key, byte[] data, boolean padding) throws Exception {
		IvParameterSpec iv = new IvParameterSpec(new byte[16]);
	...
	public void obliviate(byte[] b, int n) {
		for (int i=0; i<n; i++) {
			b[i] = 0x00;
			b[i] = 0x01;
		}
